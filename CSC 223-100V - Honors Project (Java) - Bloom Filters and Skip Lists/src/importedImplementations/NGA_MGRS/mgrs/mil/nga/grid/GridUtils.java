package importedImplementations.NGA_MGRS.mgrs.mil.nga.grid;

import importedImplementations.NGA_MGRS.mgrs.mil.nga.grid.features.Bounds;
import importedImplementations.NGA_MGRS.mgrs.mil.nga.grid.features.Line;
import importedImplementations.NGA_MGRS.mgrs.mil.nga.grid.features.Point;
import importedImplementations.NGA_MGRS.mgrs.mil.nga.grid.features.Unit;
import importedImplementations.NGA_MGRS.mgrs.mil.nga.grid.tile.Pixel;
import importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.util.GeometryConstants;
import importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.util.GeometryUtils;
...
public class GridUtils {
	...
	public static Point toUnit(double longitude, double latitude, Unit unit) {
	  importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.Point point = null;
		switch (unit) {
		case DEGREE:
	...
	public static Point intersection(Point line1Point1, Point line1Point2,
		...
		importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.Point point = GeometryUtils.intersection(
