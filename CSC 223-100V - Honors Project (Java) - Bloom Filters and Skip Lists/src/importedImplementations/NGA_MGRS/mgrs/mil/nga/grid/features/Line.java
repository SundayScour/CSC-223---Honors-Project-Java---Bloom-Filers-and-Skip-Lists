 ...
 * @author osbornb
 */
public class Line extends importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.Line {
	...
	public void setPoints(Point point1, Point point2) {
		List<importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.Point> points = new ArrayList<>();
		points.add(point1);
		points.add(point2);
		setPoints(points);
		validateUnits();
