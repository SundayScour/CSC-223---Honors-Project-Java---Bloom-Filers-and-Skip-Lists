package importedImplementations.NGA_MGRS.mgrs.mil.nga.grid.features;
 ...
 * @author osbornb
 */
public class Point extends importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.Point {
	 ...
	 * @return point
	 */
	public static Point point(importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.Point point, Unit unit) {
	 ...
	 *            unit
	 */
	public Point(importedImplementations.NGA_MGRS.mgrs.mil.nga.sf.Point point, Unit unit) {
		super(point);
		this.unit = unit;
	}
