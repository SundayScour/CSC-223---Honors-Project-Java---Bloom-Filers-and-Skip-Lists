 ...
 */
package importedImplementations.TinSpinIndexes.index.qthypercube2;

import importedImplementations.TinSpinIndexes.index.PointDistance;
import importedImplementations.TinSpinIndexes.index.util.MinHeap;
import importedImplementations.TinSpinIndexes.index.util.MinMaxHeap;

import java.util.NoSuchElementException;
import java.util.function.Predicate;

import static importedImplementations.TinSpinIndexes.index.Index.*;
import static importedImplementations.TinSpinIndexes.index.qthypercube2.QUtil.distToRectNode;
