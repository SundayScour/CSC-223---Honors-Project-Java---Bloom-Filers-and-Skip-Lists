...
import importedImplementations.TinSpinIndexes.index.*;
import importedImplementations.TinSpinIndexes.index.util.MutableRef;
import importedImplementations.TinSpinIndexes.index.util.StringBuilderLn;
...
public class RTree<T> implements BoxMap<T>, BoxMultimap<T> {
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#getDims()
	 */
	@Override
	public int getDims() {
		return dims;
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#size()
	 */
	@Override
	public int size() {
		return size;
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#clear()
	 */
	@Override
	public void clear() {
		init();
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#queryEntry(double[], double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#iterator()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#queryOverlap(double[], double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#query1N
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#queryKNN(double[], int, importedImplementations.TinSpinIndexes.index.rtree.RectangleDistanceFunction)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#getStats()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see importedImplementations.TinSpinIndexes.index.rtree.Index#getNodeCount()
	 */
	@Override
