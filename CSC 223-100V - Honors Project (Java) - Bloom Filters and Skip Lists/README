...
My Honors Project for CSC 223-100V in Fall 2023 semester,
at Laurel Ridge Community College. This class is the capstone of my Associate 
of Science: Computer Science degree from Laurel Ridge. I hope to continue my 
studies at George Mason University in Fall 2024, in their Computer Science 
department, culminating in a Bachelor’s degree in Computer Science. Any 
graduate studies will depend on my situation and financial needs at that time.
...
The hypothesis is that since Bloom Filters are so fast at excluding data queries
 which are outside The Data Set and since Skip Lists are so fast at indexing 
data within The Data Set, then, by using Bloom Filters as the first layer and 
Skip Lists as the second layer, together they can outperform an R-Tree which has
...
experience, in using projects and code from authors other than myself. Because 
I have little to no experience in doing that, thus far, a project such as this 
...
libraries. Given my own inexperience and the timescales and deadlines involved 
in this project, I regret that I did not properly include these external 
resources in my Eclipse IDE project. I have very little experience in using Git,
 and none at all in using any build tools such as Maven or Gradle.
...
gross, and brutal “hack job” to get the features I needed included and usable 
in this Honors Project.
...
demonstrable skills of each of the contributors to the projects that make up the
 vast bulk of the source code and execution time of this Honors Project. See the
 “Credits for imported implementations” section below for the repositories, 
their URIs, and their contributors, which I used for implementing the data 
